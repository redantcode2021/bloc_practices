...
import 'package:netflix/presentation/profile/profile_barrel.dart';
          ...
          GridView.builder(
            ...
            itemBuilder: ((BuildContext context, index) {
              return GestureDetector(
                onTap: () {
                  context.read<ProfileBloc>().add(SelectProfile(index));
                  context.go('/home');
                },
                child: Column(
                  mainAxisSize: MainAxisSize.max,
                  ...
                  children: [
                    Expanded(
                      child: Align(
                        ...
                        child: AspectRatio(
                          aspectRatio: 1,
                          child: ProfileIcon(color: profileColors[index]),
                        ),
                      ),
                    ),
...
class Smile extends CustomPainter {
  ...
  @override
  bool shouldRebuildSemantcs(Smile oldDelegate) => false;
}
