...
import 'package:netflix/common/widgets/bottom_sheet_button.dart';
...
class NetflixBottomSheet extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return FutureBuilder(
        future: context
            .watch<MovieRepository>()
            .getDetails(movie.id, movie.mediaType),
              ...
              children: [
                ...
                InkWell(
                  onTap: () {
                    Navigator.pop(context);
                    context.go(
                      '${GoRouter.of(context).location}/details',
                      extra: movieDetails,
                    );
                  },
                  child: Row(
